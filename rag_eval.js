...
const TEST_CASES = [
  ...
  { query: "Mera pati mar gaya, mujhe sahara chahiye", expectedId: "ignoap-widow", lang: "hi", note: "Semantic: no 'widow' keyword" },
  { query: "Old age pension for poor senior citizen", expectedId: "ignoap", lang: "en" },
  ...
  { query: "Matric scholarship for SC student", expectedId: "post-matric-scholarship-sc", lang: "en" },
  ...
  { query: "Widow pension for woman whose husband died", expectedId: "ignoap-widow", lang: "en" },
  { query: "Machli palan ke liye loan chahiye", expectedId: "pm-matsya", lang: "hi", note: "Fisheries — semantic" },
  ...
  { query: "Ghar banane ke liye paisa chahiye", expectedId: "pm-awas", lang: "hi", note: "Housing scheme" },
  ...
  { query: "Pregnant woman nutrition support", expectedId: "pmmvy", lang: "en", note: "PMMVY — semantic" },
  { query: "Disability pension monthly allowance", expectedId: "igndps", lang: "en", note: "Disability scheme" },
];
